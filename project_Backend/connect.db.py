...
'''
myConn.execute("SELECT * FROM package_table")
...
'''
#select employees.employee_ID, employees.personal_items, vehicle_data.trunk_space, vehicle_data.foldable_seat_space FROM employees LEFT JOIN vehicle_data ON employees.car_ID = vehicle_data.car_ID;
